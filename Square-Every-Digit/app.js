function squareDigits(num){
    return parseInt(Array.from(String(num), Number).map(el=>Math.pow(el,2)).join(""));
  }

//   Explanation
// 1- String(num) will convert the number 12345 into a string, returning '12345'
...
// The code line Array.from(String(num), Number); will convert the number into a string, take each character of that string, convert it into a number and put in a new array. Finally, this new array of numbers will be returned.